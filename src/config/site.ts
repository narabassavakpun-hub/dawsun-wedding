...
const layoutOverrides: Record<string, PhotoLayout> = {
  ...
  'couple-05.webp': 'full',
  // ใบสุดท้าย เป็นภาพครึ่งตัว หน้าอยู่ครึ่งบน ครอป 3:2 เป็นแบนเนอร์ปิดท้ายได้สวย
  'couple-10.webp': 'banner',
};
...
export const copy = {
  ...
  gift: {
    ...
    slipHeading: 'แนบสลิปให้บ่าวสาว',
    slipHint: 'โอนเรียบร้อยแล้ว แนบสลิปไว้ให้บ่าวสาวได้ไหมคะ',
